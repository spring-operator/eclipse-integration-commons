...
public class GotoSymbolDialog extends SelectionStatusDialog {
...
//		};
	...
	private static final String DIALOG_SETTINGS = GotoSymbolDialog.class.getName()+".DIALOG_SETTINGS";
	 ...
	 */
	public GotoSymbolDialog(IWorkbenchWindow window) {
		super(window.getShell());
		this.setTitle("Goto Symbol");
...
//		refreshCacheJob.schedule();
	 ...
	 * @see GotoSymbolDialog#FULL_SELECTION
	 */
	 ...
	 *           initial pattern for the filter
	 * @param selectionMode
	 *           one of: {@link GotoSymbolDialog#NONE},
	 *           {@link GotoSymbolDialog#CARET_BEGINNING},
	 *           {@link GotoSymbolDialog#FULL_SELECTION}
	 */
...
//		}
		...
		public void updateElement(int index) {
			...
			GotoSymbolDialog.this.list.replace((items
